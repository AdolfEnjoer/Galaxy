...
let item_descr = ['Тарелка с принтом Марса Доступна в', 'Кружка с принтом Марса Доступна в', 'Масштабная модель одной из ракет Galaxy', 'Масштабная модель марсохода']


let item_price_objects = document.querySelectorAll('.merch-item-price')
let item_price = ['1000', '1000', '2500', '5000']
for (let i = 0; i < item_descr.length; i += 1) 
{
...
let button_bucket=document.querySelector('.add-to-cart-btn')
button_bucket.addEventListener('click',cart_amount_change)
function cart_amount_change(){
